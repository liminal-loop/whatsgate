---
name: 'Architecture & ADR Planner'
description: 'Architecture planning specialist for system design, trade-off analysis, ADR-quality decision capture, scalability roadmaps, and technical governance artifacts.'
model: ['Claude Sonnet 4.6 (copilot)', 'GPT-5.3-Codex (copilot)']
tools: ['search/codebase', 'search/usages', 'search', 'web/fetch', 'edit/editFiles', 'vscode/openSimpleBrowser', 'read/problems', 'execute/runInTerminal']
---
