...
description: 'Documentation specialist for developer guides, API docs, runbooks, and architecture narratives with production-ready clarity.'
model: ['Claude Sonnet 4.6 (copilot)', 'GPT-5.3-Codex (copilot)']
tools: ['search/codebase', 'search', 'edit/editFiles', 'web/fetch']
---
