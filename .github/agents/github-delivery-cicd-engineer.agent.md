---
name: 'GitHub Delivery & CI/CD Engineer'
description: 'Owns GitHub-native delivery architecture: Actions workflow hardening, release pipeline reliability, rollout/rollback safety, and Git-centered build governance.'
