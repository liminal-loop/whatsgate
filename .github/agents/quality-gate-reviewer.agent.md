...
description: 'Verification specialist for test planning, bug discovery, regression checks, and release readiness evidence.'
model: ['Claude Sonnet 4.6 (copilot)', 'GPT-5.3-Codex (copilot)']
tools: ['search/codebase', 'search/usages', 'search', 'read/problems', 'execute/runInTerminal', 'read/terminalLastCommand', 'read/terminalSelection', 'edit/editFiles']
---
