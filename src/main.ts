...
//   3. data/.env.generated (auto-generated config; created on first run)
//
// Rationale: explicit env vars from the host/orchestrator must always win
// so that operators can override the generated config without having
...
// 3. Generated config (does not override .env or process env)
